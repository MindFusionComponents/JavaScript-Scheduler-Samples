...
(function (GardenCalendar) {
    ...
    GardenCalendar.addCrop = addCrop;
    function removeCrop() {
    ...
    GardenCalendar.removeCrop = removeCrop;
    function refreshCrops() {
        var option;
        var i;
        for (i = document.getElementById("crops").options.length - 1; i >= 0; i--) {
            document.getElementById("crops").options.item(i).remove();
        }
...
//# sourceMappingURL=GardenCalendar.js.map